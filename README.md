...
10. [⌨️ คีย์ลัด (Keyboard Shortcuts)](#️-keyboard-shortcuts)
11. [🧪 การรันชุดทดสอบอัตโนมัติ (Running Automated Tests)](#-running-automated-tests)
12. [📁 โครงสร้างโปรเจกต์ (Repository Structure)](#-repository-structure)
...
### 1. Clone Source Code
```bash
git clone https://github.com/your-username/typhoon-transcriber.git
cd typhoon-transcriber/src
```
...
| **`A+` / `A-`** | Zoom Transcript Font Size in / out |
